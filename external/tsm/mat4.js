...
(function (kisaragi) {
    var mat4 = (function () {
        ...
        mat4.lookAt = function (position, target, up) {
            if (up === void 0) { up = kisaragi.vec3.up; }
            if (position.equals(target)) {
                return this.identity;
            }
            var z = kisaragi.vec3.difference(position, target).normalize();
            var x = kisaragi.vec3.cross(up, z).normalize();
            var y = kisaragi.vec3.cross(z, x).normalize();
            return new mat4([
                x.x,
                y.x,
                z.x,
                ...
                z.z,
                0,
                -kisaragi.vec3.dot(x, position),
                -kisaragi.vec3.dot(y, position),
                -kisaragi.vec3.dot(z, position),
                1
            ]);
        };
