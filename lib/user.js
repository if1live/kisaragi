(function() {
  ...
  User.prototype.c2s_requestMap = function(world, obj) {
    var self = this;
    self.sock.send('s2c_responseMap', world.level.serializer().serialize());
  };
...
//    }
    ...
    world.level.tile(self.pos[0], self.pos[1], world.level.TILE_EMPTY);
    world.level.tile(pos[0], pos[1], world.level.TILE_PLAYER);
