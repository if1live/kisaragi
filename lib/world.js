(function() {
  ...
  var _ = null, Enemy = null, User = null, Level = null, base = null;
  ...
  World.prototype.removeObject = function(obj) {
    var helper = this.objectListHelper(obj.category);
    helper.removeObject(obj);
    this.objectListTable[obj.category] = helper.list;
  };
  ...
  World.prototype.syncAllObjectList = function(dataList) {
    ...
    var prevIdList = _.each(self.allObjectList(), function(obj, i) { return obj.id; });
    var nextIdList = _.each(dataList, function(obj, id) { return obj.id; });
